from 情感分类.EmotionWord import *
Sentiments_words = pos_envalute + pos_emotion + neg_envalute +neg_emotion
Sentiments_words = set(Sentiments_words)
Sentiments_words = [i for i in Sentiments_words]
# 结点类
class node:
...
# acp.ac_automation()
#
# # text = "美国贸易代表办公室将在接下来的“几天”公布拟议的清单。"
# #
# # d = acp.runkmp(text)
